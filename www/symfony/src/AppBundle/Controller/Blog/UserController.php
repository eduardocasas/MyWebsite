...
class UserController extends Controller
{
    public function logoutAction($date, $slug)
    {
        ...
        return $this->redirect($this->generateURL('blog_article', ['date' => $date, 'slug' => $slug]).'#comments');
    }
    ...
    {
        (new Session())->set('url_redirect', $this->generateURL('blog_article', ['date' => $date, 'slug' => $slug]).'#comments');
